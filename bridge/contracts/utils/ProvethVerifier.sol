    ...
    function validateMPTProof(
        ...
        for (uint i = 0; i < stack.length; i++) {
            ...
            if (i == 0 && rootHash != keccak256(rlpNode)) {
                revert("validateMPTProof: root hash mismatch");
            }
            // ... whereas all other nodes are hashed with the MPT
            // hash function.
            if (i != 0 && nodeHashHash != mptHashHash(rlpNode)) {
                revert("validateMPTProof: node hash mismatch");
            }
            ...
            if (node.length == 2) {
                ...
                if (prefixLength < nodeKey.length) {
                    ...
                    if (i < stack.length - 1) {
                        ...
                        revert("validateMPTProof: divergent node not at last level");
                    }
                ...
                if (isLeaf) {
                    ...
                    if (i < stack.length - 1) {
                        ...
                        revert("validateMPTProof: leaf node not at last level");
                    }
                    ...
                    if (i == stack.length - 1) {
                        ...
                        revert("validateMPTProof: extension node at last level");
                    }
                ...
                if (mptKeyOffset != mptKey.length) {
                    ...
                    if (nibble >= 16) {
                        ...
                        revert("validateMPTProof: path not a nibble");
                    }
                    ...
                    if (isEmptyBytesequence(node[nibble])) {
                        ...
                        if (i != stack.length - 1) {
                            ...
                            revert("validateMPTProof: empty branch node not at last level");
                        }
                    ...
                    if (i != stack.length - 1) {
                        ...
                        revert("validateMPTProof: branch node not at last level");
                    }
